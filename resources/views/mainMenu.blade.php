...
<div class="container-lg pt-5">
    ...
    <div class="card-deck">
        ...
        <div class="card" style="height:21rem; width: 15rem;">
            ...
            <div class="card-body">
                <h4 class="card-title" style="align:center;"><center>Order Management for Individual Buyers</center></h4>
                <!--<p class="card-text">Operations related to individual order management</p>--><br>
                <center>  <a href="/subBillingMenu" class="btn btn-primary">Enter</a></center>
            </div>
        </div>
    ...
    <div class="card-deck">
        ...
        <div class="card" style="height:21rem; width:15rem;">
            ...
            <div class="card-body">
                ...
                <center>  <a href="/viewfeedback" class="btn btn-primary">Enter</a></center>
            </div>
        </div>
